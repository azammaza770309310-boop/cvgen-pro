    ...
    return rx.box(
        ...
        rx.vstack(
            ...
            rx.flex(
                ...
                rx.button("مساعد الذكاء ✨", on_click=ResumeState.parse_resume_ai("", "", "auto"), variant="ghost", color="#fbbf24", size="2"),
                rx.button("↶", variant="ghost", color="white", size="2"),
                rx.button("↷", variant="ghost", color="white", size="2"),
                rx.button("💾 حفظ", on_click=ResumeState.export_docx, variant="ghost", color="white", size="2"),
