...
PARSE_SYSTEM_PROMPT = (
    ...
    "Each English bullet MUST have a precise Arabic translation in the corresponding Arabic bullet at the same index.\n"
    "5. The number of items in skills_en MUST equal skills_ar. Translate each skill precisely.\n"
    "6. The number of items in technical_skills_en MUST equal technical_skills_ar. Translate each precisely.\n"
    ...
    "STRICT 1:1 MATCHING RULE (HIGHEST PRIORITY — NEVER VIOLATE):\n"
    "MUST STRICTLY MATCH 1:1. Every single item, skill, and bullet point in the English section MUST have an exact "
    "Arabic translation in the Arabic section. Do not summarize or omit any fields. If a Technical Skill is added in "
    "English, it must be translated and added to the Arabic Technical Skills array. The same applies to Skills, "
    "Experience bullets, Education entries, Courses, and Languages — the Arabic arrays must be a complete, "
    "item-for-item translation of the English arrays, with identical length and matching index-to-index meaning.\n\n"
    "REAL TRANSLATION RULE (NEVER COPY ENGLISH INTO ARABIC):\n"
    "The Arabic fields MUST contain REAL Arabic translations, not copies of the English text.\n"
    "- CORRECT: English 'Microsoft Office' → Arabic 'مايكروسوفت أوفيس'\n"
    "- WRONG:   English 'Microsoft Office' → Arabic 'Microsoft Office'  (copying is forbidden)\n"
    "- CORRECT: English 'Senior Software Engineer' → Arabic 'مهندس برمجيات أول'\n"
    "- WRONG:   English 'Senior Software Engineer' → Arabic 'Senior Software Engineer'\n"
    "If you cannot translate an item (e.g. a brand name like 'Python' or 'AWS' that has no Arabic equivalent), "
    "leave it in its original script — but NEVER copy a translatable English phrase verbatim into an Arabic field.\n"
    "Language-neutral items (emails, phones, URLs, pure numbers, dates) stay as-is in both languages.\n\n"
    "STRICT LANGUAGE ISOLATION (100% ENFORCED):\n"
    "- It is STRICTLY FORBIDDEN to put any Arabic word inside English-designated fields (skills_en, technical_skills_en, bullets_en, summary.en, etc.).\n"
    "- It is STRICTLY FORBIDDEN to put any English word inside Arabic-designated fields (skills_ar, technical_skills_ar, bullets_ar, summary.ar, etc.).\n"
    "- Language isolation MUST be 100%. English fields contain ONLY English. Arabic fields contain ONLY Arabic.\n"
    "- Each English bullet MUST be a precise translation of the Arabic bullet at the same index, and vice versa.\n\n"
    "DATE FORMAT RULES:\n"
